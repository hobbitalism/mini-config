...
class YamlConfigSectionTest {
    ...
    private YamlConfigSection section;

    @BeforeEach
    void setUp() throws IOException {
        section = new YamlConfigLoader().load(new StringReader(YAML));
    }
    ...
    void roundTrip_serializeThenReload_preservesValues() throws IOException {
        ...
        new YamlConfigSerializer().save(section, writer);

        YamlConfigSection reloaded = new YamlConfigLoader().load(new StringReader(writer.toString()));
